    ...
    -- Library element functions
        function library:window(properties)
            local cfg = { 
                ...
                name = properties.name or properties.Name or "astral";
                game_name = properties.gameInfo or properties.game_info or properties.GameInfo or "Made for the Future ";
            ...
            local items = cfg.items; do
                ...
                items[ "other_info" ] = library:create( "TextLabel" , {
                    ...
                    TextColor3 = themes.preset.accent;
                    BorderColor3 = rgb(0, 0, 0);
                    Text = 'made by @highclasses ' .. cfg.name .. cfg.suffix;
                    Size = dim2(1, 0, 0, 0);
                    Position = dim2(0, -10, 0.5, -1);
                    AnchorPoint = vec2(0, 0.5);
                    BorderSizePixel = 0;
